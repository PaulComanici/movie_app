...
import {createItem, getItems, newWebSocket, updateItem} from "./api/movieAPI";

type SaveItemFn = (item: Movie) => Promise<any>;
...
export const ItemProvider: React.FC<ItemProviderProps> = ({children}) => {
    ...
    async function saveItemCallback(movie: Movie) {
        try {
            dispatch({type: SAVE_ITEM_STARTED});
            const savedItem = await (movie.id ? updateItem(movie) : createItem(movie));
